...
local palettes = {
  dark = {
    base16 = {
      ...
      base02 = "#282828", -- bg1 (surface0)
      base03 = "#3c3836", -- bg3 (surface1)
      base04 = "#504945", -- bg5 (surface2)
      base05 = "#d4be98", -- fg0 (foreground)
      base06 = "#ddc7a1", -- fg1 (subtext1)
      base07 = "#a89984", -- grey2 (subtext0)
      base08 = "#ea6962", -- red
      base09 = "#e78a4e", -- orange (peach)
      base0A = "#d8a657", -- yellow
      base0B = "#a9b665", -- green
      base0C = "#89b482", -- aqua (teal)
      base0D = "#7daea3", -- blue
      base0E = "#d3869b", -- purple (mauve)
      base0F = "#141617", -- bg_dim (crust)
    },
    p = {
      base     = "#1d2021", -- bg0
      mantle   = "#191b1c",
    ...
    diff = {
      add    = "#32361a", -- bg_diff_green
      delete = "#3c1f1e", -- bg_diff_red
      change = "#0d3138", -- bg_diff_blue
      text   = "#473c29", -- bg_visual_yellow
    },
    conflict = {
      ours   = "#333e34", -- bg_visual_green
      base   = "#473c29", -- bg_visual_yellow
      theirs = "#2e3b3b", -- bg_visual_blue
    },
  },
  light = {
    base16 = {
      base00 = "#f9f5d7", -- bg0 (background)
      base01 = "#f3eac7", -- mantle (bg2)
      base02 = "#f5edca", -- bg1 (surface0)
      base03 = "#f2e5bc", -- bg3 (surface1)
      base04 = "#eee0b7", -- bg4 (surface2)
      base05 = "#654735", -- fg0 (foreground)
      base06 = "#4f3829", -- fg1 (subtext1)
      base07 = "#7c6f64", -- grey2 (subtext0)
      base08 = "#c14a4a", -- red
      base09 = "#c35e0a", -- orange (peach)
      base0A = "#b47109", -- yellow
      base0B = "#6c782e", -- green
      base0C = "#4c7a5d", -- aqua (teal)
      base0D = "#45707a", -- blue
      base0E = "#945e80", -- purple (mauve)
      base0F = "#ebdbb2", -- bg5 (crust)
    },
    p = {
      base     = "#f9f5d7", -- bg0
      mantle   = "#f3eac7", -- bg2
    ...
    diff = {
      add    = "#e4edc8", -- bg_diff_green
      delete = "#f8e4c9", -- bg_diff_red
      change = "#e0e9d3", -- bg_diff_blue
      text   = "#f9eabf", -- bg_visual_yellow
    },
    conflict = {
      ours   = "#dde5c2", -- bg_visual_green
      base   = "#f9eabf", -- bg_visual_yellow
      theirs = "#d9e1cc", -- bg_visual_blue
    },
  },
}

local function apply_theme(variant)
  local theme = palettes[variant] or palettes.dark
  base16.setup({ palette = theme.base16, use_cterm = false })
  ...
  -- Diff highlights
  hi("DiffAdd", { bg = theme.diff.add })
  hi("DiffDelete", { bg = theme.diff.delete })
  hi("DiffChange", { bg = theme.diff.change })
  hi("DiffText", { bg = theme.diff.text })
  -- Git conflict marker highlights (matchadd-based, no plugin needed)
  hi("GitConflictMarkerOurs", { bg = theme.conflict.ours, bold = true })
  hi("GitConflictMarkerBase", { bg = theme.conflict.base, bold = true })
  hi("GitConflictMarkerTheirs", { bg = theme.conflict.theirs, bold = true })
  ...
  -- Sync lualine theme with the active palette
  if _G.LualineApplyPalette then
    pcall(_G.LualineApplyPalette, p)
  end
end

_G.MiniThemeVariant = "dark"
apply_theme(_G.MiniThemeVariant)
vim.opt.background = _G.MiniThemeVariant

function _G.Toggle_colorscheme()
  _G.MiniThemeVariant = _G.MiniThemeVariant == "dark" and "light" or "dark"
  apply_theme(_G.MiniThemeVariant)
  vim.opt.background = _G.MiniThemeVariant
  print("Colorscheme: " .. _G.MiniThemeVariant)
end
