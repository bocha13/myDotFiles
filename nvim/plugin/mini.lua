...
local palettes = {
  ...
  light = {
    base16 = {
      base00 = "#fbf1c7", -- base (background)
      base01 = "#f2e5bc", -- mantle
      base02 = "#ebdbb2", -- surface0
      base03 = "#d5c4a1", -- surface1
      base04 = "#bdae93", -- surface2
      base05 = "#3c3836", -- text (foreground)
      base06 = "#504945", -- subtext1
      base07 = "#665c54", -- subtext0
      base08 = "#c14a4a", -- red
      base09 = "#c35e0a", -- peach
      base0A = "#b47109", -- yellow
      base0B = "#6c782e", -- green
      base0C = "#4c7a5d", -- teal/sky/sapphire
      base0D = "#45707a", -- blue
      base0E = "#945e80", -- mauve/pink
      base0F = "#a89984", -- crust
    },
    p = {
      base     = "#fbf1c7",
