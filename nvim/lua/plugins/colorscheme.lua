        ...
        highlight_overrides = {
          all = function(colors)
            return {
              ...
              TelescopePreviewTitle       = { fg = colors.surface2, bg = colors.crust },
              TelescopePromptBorder       = { bg = colors.surface0, fg = colors.surface0 },
              TelescopePromptCounter      = { fg = colors.mauve, style = { "bold" } },
              TelescopePromptNormal       = { bg = colors.surface0 },
              TelescopePromptPrefix       = { bg = colors.surface0 },
              TelescopePromptTitle        = { fg = colors.text, bg = colors.surface0 },
              TelescopeResultsBorder      = { bg = colors.mantle, fg = colors.mantle },
              TelescopeResultsNormal      = { bg = colors.mantle },
              TelescopeResultsTitle       = { fg = colors.surface2, bg = colors.mantle },
              TelescopeSelection          = { bg = colors.surface0 },
              WinSeparator                = { bg = colors.base, fg = colors.blue },
              YankHighlight               = { bg = colors.surface2 },
              FidgetTask                  = { fg = colors.text },
              FidgetTitle                 = { fg = colors.peach },
              FloatTitle                  = { fg = colors.text, bg = colors.surface0, bold = true },
              FloatFooter                 = { fg = colors.surface2, bg = colors.surface0, italic = true },
